...
const string strMessageMagic = "AndroidsToken Signed Message:\n";
    ...
    int64 nRewardCoinYear;
{
        ...
        // AndroidsToken: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in AndroidsToken
    bool fStrictPayToScriptHash = true; // Always active in AndroidsToken
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AndroidsToken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "AndroidTokens are GO!";
        CTransaction txNew;
		...
		txNew.strTxComment = "text: AndroidToken genesis block";
